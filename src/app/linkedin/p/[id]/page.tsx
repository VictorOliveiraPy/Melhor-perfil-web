...
// /boards/linkedin deixa de ser encontrado aqui.
export default async function LinkedInProfileDetail({ params }: Props) {
  const ranked = rankListings(await fetchBoardListings('linkedin'))
